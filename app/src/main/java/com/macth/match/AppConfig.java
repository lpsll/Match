...
public class AppConfig {
    ...
    public static final String DETAILS_H5_URL = "http://cuohe.damaimob.com/CuoHeApp/html/ItemDec.html?";//项目详情
    public static final String MY_DETAILS_H5_URL = "http://cuohe.damaimob.com/CuoHeApp/html/MyItemDec.html?userid=";//我的项目详情
    public static final String FX_URL = "http://cuohe.damaimob.com/CuoHeApp/html/ShareItem.html?";//分享
