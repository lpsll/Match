 ...
 * 我的里程碑h5页
 */
public class MyMilepostActivityBrowserActivity extends BaseTitleActivity {
    ...
    public class JavaScriptInterface {
        ...
        public void MilestoneDec(String PID,String DId) {
            ...
            UIHelper.showBundleFragment(MyMilepostActivityBrowserActivity.this, SimplePage.UPDATA_MILESTONE,bundle);//更新里程碑
        }
    }
